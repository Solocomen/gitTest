...
public class EpcCreateGupUserPin implements EpcGupInput {
    ...
    @EpcGupField(fieldName="smcPINUpdateDate",fieldType="gupfield")
    private String pinUpdateDate;
    @EpcGupField(fieldName="smcUserRemindTimes",fieldType="gupfield")
    private String userRemindTimes;
    @EpcGupField(fieldName="smcSimplePIN",fieldType="gupfield")
    @EpcGupEncryptField
    ...
    @EpcGupField(fieldName="smcSimplePINUpdateDate",fieldType="gupfield")
    private String simplePINUpdateDate;
    @EpcGupField(fieldName="smcUserRecNo",fieldType="gupfield")
    private String userRecNo;
    @EpcGupField(fieldName="smcPIN1",fieldType="gupfield")
    @EpcGupEncryptField
    private String pin1;
    @EpcGupField(fieldName="smcOnlinePIN1",fieldType="gupfield")
    @EpcGupEncryptField
    private String onlinePin1;
    @EpcGupField(fieldName="smcResetOnlinePIN",fieldType="gupfield")
    private String resetOnlinePin;
    @EpcGupField(fieldName="smcOnlinePINUpdateDate",fieldType="gupfield")
    private String onlinePinUpdateDate;
    ...
    public String getPinUpdateDate() {
        return pinUpdateDate;
    }

    public void setPinUpdateDate(String pinUpdateDate) {
    ...
    public String getSimplePINUpdateDate() {
        return simplePINUpdateDate;
    }

    public void setSimplePINUpdateDate(String simplePINUpdateDate) {
        this.simplePINUpdateDate = simplePINUpdateDate;
    }
    ...
    public String getOnlinePin1() {
        return onlinePin1;
    }

    public void setOnlinePin1(String onlinePin1) {
        this.onlinePin1 = onlinePin1;
    }
    ...
    public String getOnlinePinUpdateDate() {
        return onlinePinUpdateDate;
    }

    public void setOnlinePinUpdateDate(String onlinePinUpdateDate) {
        this.onlinePinUpdateDate = onlinePinUpdateDate;
    }
